...
We also report the divergences in model fit across 200 simulated datasets per detection probability (@tbl-div-results). On average, the model had low divergence rates across all detection probabilities, with higher rates at higher detection probabilities. 

```{r, include=T,echo=F}
#| label: tbl-div-results
#| tbl-cap: "Summary of divergences across 200 simulations for each detection probability."
#| tbl-colwidths: [15,10,10,10,10,10,10]
rate_div %>%
