...
Note that by construction, $\pi^{SE}_{g,t},\pi^{EI}_{g,t},\pi^{IR}_{g,t}$ are bounded in the intervals $[0,s_{g,t-1}], [0, e_{g,t-1}], [0, i_[g,t-1]]$ respectively.
We can respect these bounds by creating scale-free latent variables $u^{SE}_{g,t},u^{EI}_{g,t},u^{IR}_{g,t}$ each bounded in $[0,1]$
