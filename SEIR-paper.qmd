...
While our case study model fit had no divergences, the simulation study had some divergences across detection probabilities (@tbl-div-results). On average, the there were low divergence rates across all detection probabilities, with higher rates at higher detection probabilities. 
