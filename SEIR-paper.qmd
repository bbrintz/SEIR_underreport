...
Despite these innovations, there are limitations to each approach. The LNA approach approximates transition densities with a multivariate Gaussian that is appropriate 
